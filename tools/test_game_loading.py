...
def create_diagnostic_page():
    """Create diagnostic page to test game loading"""
...
<body>
    ...
    with open('tools/test_game_loading.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print("✅ Создана диагностическая страница: tools/test_game_loading.html")
    print("🌐 Откройте файл в браузере для диагностики проблем с загрузкой")
